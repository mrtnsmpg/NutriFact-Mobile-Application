            ...
            if (entry.getValue()==maxValueInMap) {
                ...
                switch (entry.getKey()){
                    ...
                    case "Pineapple":
                        ...
                        message = "This is pineapple.";
                        break;
                    case "Watermelon":
                        fruitName = "watermelon";
                        textFruitName.setText("Watermelon");
                        message = "This is watermelon.";
                        break;
                }
